...
public class DeviceStatusLog {
    ...
    // ==========================================
    // 03 即時狀態 (Status Data) - 遙測數據
    // ==========================================
    private Integer unitStatus;      // 狀態 (1=Normal, 2=Alarm)
    private Double temperature;      // 溫度 (℃)
    private Double voltage;          // 電壓 (V)
    private Integer ripple;          // 漣波 (mV)
    ...
    private Double pilotLowPwr;      // 低頻導頻功率 (dBmV)
    private Double pilotHighPwr;     // 高頻導頻功率 (dBmV)
    private Double outputSlope;      // Output Slope (dB)
    private Double userPilotLowPwr;  // User setting Pilot Low Pwr
    private Double userPilotHighPwr; // User setting Pilot High Pwr
    private Integer lowPilotFreq;    // Low Pilot Freq (MHz)
    private Integer highPilotFreq;   // High Pilot Freq (MHz)
    private Integer ceqIndexStatus;  // CEQ Index

    // ==========================================
    // 03 即時狀態 - 細節警報旗標 (1: Alarm/Unlock, 0: Normal/Lock)
    // ==========================================
